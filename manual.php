...
<body>
  ...
  <div  id="pmanual"> 
  <center> <p id="paragrafo-manual"> IP fixo </p> </center>
</div>
  ...
  <div class="imagem-manual">
	...
	<section> 
		 ...
		 <center><a href="#formulario1"><button id="button-manual">Iniciar</button></a></center>

		<br><br><br><br>
		<div class="form-servico-manual">
		<form id="formulario1" action="manual.sh" method="post">
			<center>

			Endereçamento IP:<br>
			<input type="text" name="ip" placeholder=""> <br> <br>

			gateway4:<br>
                        <input type="text" name="gateway"> <br> <br>
			
			<input type="submit" value="Enviar" id="button-manual">
