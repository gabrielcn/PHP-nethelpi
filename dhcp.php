...
<nav class="menu">
  ...
  <div  id="pdhcp"> 
  <center> <p id="paragrafo-dhcp"> IP dinamico </p> </center>
</div>

  <div class="imagem-dhcp">
    <center> 
	...
	<section> 
		 ...
		 <center><a href="#formulario1"><button id="button-dhcp">Iniciar</button></a></center>

		<br><br><br><br>
		<div class="form-servico-dhcp">
		<form id="formulario1">
			<center>

        <p id="dhcp4"><strong>DHCP4:</strong></p>
	...
	<input type="text" name="gateway"> <br>
			...
			<button id="button-dhcp"> Enviar </button>
  ...
  <ul class="sci">
    ...
    <div class="sec quickLinks">
      <h2> Quick Links </h2>
      <ul>
        <li> <a href="https://nethelpi.com.br/faq.html"> <i class="fa fa-search" aria-hidden="true"></i> FAQ </a> </li>
