...
<body>
  ...
  <div  id="papache"> 
    <center> <p id="paragrafo-apache"> Access Point </p> </center>
  </div>
  
    <div class="imagem-apache">
      <center> 
      <img src="AP.png">
    </center>
    </div> 
    ...
    <center><a href="#formulario1"><button id="button-apache">Iniciar</button></a></center>
    <br>

   <br><br><br><br>
   <div class="form-servico-apache">
   <form id="formulario1" action="hostapd.sh" method="post">
     <center>

			SSID:<br>
			<input type="text" name="ssid" placeholder=""> <br> <br>

			Passphrase:<br>
			<input type="password" name="passphrase" placeholder=""> <br> <br>

			Channel:<br>
			<input type="number" name="channel" placeholder="ex: 1 a 7"> <br> <br>

                        Subnet:<br>
                        <input type="text" name="subnet" placeholder="ex: 192.168.10.0"> <br> <br>

			Address gateway4:<br>
			<input type="text" name="address-gw" placeholder="ex: 192.168.10.1"> <br> <br>

                        Netmask:<br>
                        <input type="text" name="netmask" placeholder=""> <br> <br>

                        Broadcast:<br>
                        <input type="text" name="broadcast" placeholder=""> <br> <br>

                        Range start:<br>
                        <input type="text" name="range-start" placeholder="ex: 192.168.10.2"> <br> <br>

                        Range end:<br>
                        <input type="text" name="range-end" placeholder="ex: 192.168.10.15"> <br> <br>

                        DNS 1:<br>
                        <input type="text" name="text" placeholder="ex: 8.8.8.8"> <br> <br>

                        DNS 2:<br>
                        <input type="text" name="text" placeholder="ex: 8.8.4.4"> <br> <br>
