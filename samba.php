...
<body>
  ...
  <div  id="psamba"> 
  <center> <p id="paragrafo-samba"> Servidor Samba </p> </center>
</div>

  <div class="imagem-samba">
    <center> 
    <img src="samba.png">
  </center>
  </div> 
	...
	<section> 
		 ...
		 <center>
		 <p> Clique em "Iniciar" para configurar o compartilhamento </p>
		 </center> <br>

		 <center><a href="#formulario1"><button id="button-samba">Iniciar</button></a></center>
                 
		 <form id="formularioinstalar" action="sambaapt.sh" method="post">
		 <br>
		 <!--id="paragrafo"--> <p> Não tem o Samba? Instale agora! </p> 
		 <input type="submit" value="Instalar">
		 </form>
     <br>

		<br><br><br><br>
		<div class="form-servico-samba">
		
			<form id="formulario1" action="samba.sh" method="post">
                    
			<center>

			Nome do Arquivo:<br>
                        <input type="text" name="nomearq" placeholder=""> <br> <br>

			Comentário:<br>
			<input type="text" name="comentario" placeholder=""> <br> <br>

			Caminho:<br>
			<input type="text" name="caminho" placeholder=""> <br> <br>

			Registre o usuário:<br>
			<input type="text" name="usuario" placeholder=""> <br> <br>
